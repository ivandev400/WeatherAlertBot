...
namespace WeatherAlertBot.Controllers.Commands
{
    public class StartCommand : ICommand
    {
        ...
        public StartCommand(ICreateUserService createUserService, IReplyKeyboard replyMarkup)
        {
        ...
        public async Task Execute(Update update)
        {
            ...
            await Client.SendTextMessageAsync(chatId, textMessage, replyMarkup: replyMarkup.GetPermanentMarkup());
        }
    }
}
